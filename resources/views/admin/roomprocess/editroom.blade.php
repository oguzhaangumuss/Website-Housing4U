    ...
    <div class="container my-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <!-- Düzenleme Formu -->
                <form action="{{ route('admin.roomprocess.updateRoom', $room->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="service_fee" name="service_fee" value="{{ $room->service_fee }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="key_price" class="form-label">Key Price</label>
                            <input type="number" step="0.01" class="form-control" id="key_price" name="key_price" value="{{ $room->key_price }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="rent_price" class="form-label">Rent Price</label>
                            <input type="number" step="0.01" class="form-control" id="rent_price" name="rent_price" value="{{ $room->rent_price }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="available_from" class="form-label">Available From</label>
                            <input type="date" class="form-control" id="available_from" name="available_from" value="{{ $room->available_from }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="available_until" class="form-label">Available Until</label>
                            <input type="date" class="form-control" id="available_until" name="available_until" value="{{ $room->available_until }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
